...
const Signup = () => {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    console.log('Signup attempt:', { name, email, plan: planParam || 'free' });
    
    // Show a success toast
    toast({
      title: "Account created!",
      description: "Welcome to Arch AI. You can now log in.",
    });
  };
    ...
    <div className="min-h-screen flex flex-col justify-center items-center py-12 bg-muted/30">
      <div className="sm:mx-auto sm:w-full sm:max-w-md">
        ...
        <p className="mt-2 text-center text-muted-foreground">
          {planParam 
            ? `You're signing up for the ${planParam.charAt(0).toUpperCase() + planParam.slice(1)} plan` 
            : 'Start building cloud architectures with AI'}
        </p>
      </div>
